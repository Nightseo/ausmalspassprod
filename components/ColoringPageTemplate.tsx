...
type ColoringPageTemplateProps = {
  slug: string
}

export default function ColoringPageTemplate({ slug }: ColoringPageTemplateProps) {
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:flex-1">
              <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
                <h2 className="text-3xl font-bold tracking-tight mb-4 text-gray-900">{page.title}</h2>
              ...
              <div className="bg-white rounded-xl shadow-sm p-6">
                <h2 className="text-2xl font-bold mb-6 text-gray-900">Ähnliche Ausmalbilder</h2>
                    ...
                    .map((relatedPage) => (
                      <Link key={relatedPage.id} href={`/${relatedPage.slug}`} className="group">
                        <div className="bg-slate-50 rounded-lg overflow-hidden border border-slate-200 transition-all group-hover:shadow-md group-hover:translate-y-[-3px] duration-300">
                          ...
                          <div className="p-4">
                            <h3 className="font-medium text-gray-900 group-hover:text-emerald-500 transition-colors line-clamp-2">
                              {relatedPage.title}
                            </h3>
                          </div>
                        </div>
